...
void OLEDDisplay::printEncoderCounts(int leftEncoderCount, int rightEncoderCount) {
  display.clearDisplay();

  display.setTextSize(1);
  display.setTextColor(SSD1306_WHITE);

  // Print left encoder count
  display.setCursor(0, 0);
  display.print("Left Encoder: ");
  display.println(leftEncoderCount);

  // Print right encoder count
